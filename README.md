...
sudo -u postgres psql -d ScriptNest_db  # Connect to database
```
...
export DB_PORT=5432
export DB_USER=ScriptNest_user
export DB_PASSWORD=ScriptNest_pass_2026
export DB_NAME=ScriptNest_db
export PORT=5000
